...
const stripePromise = loadStripe("pk_test_51M0lMHBnz6sFD08MPGj1OD6Ki7OvgQP8wpokgKjeXupLP7Yz04YAq14IsYVUsAPIPc54pX1is7oHsTg7ObzFhwNT0069NBIT0Y");
        ...
        <Container style={{ minHeight: "95vh" }} className="cart-container">
            <Row>
                <Col>
                    ...
                    {cart.length == 0 ? (
                        <Alert variant="info">El carrito de compras esta vacio.
                        <br/>
                        Visita tus ordenes o sigue navegando y añade nuevos productos al carro</Alert>
                    ) : (
