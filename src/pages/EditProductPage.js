...
function EditProductPage() {
    ...
    function handleSubmit(e) {
        ...
        updateProduct({ id, name, description, talles,tela,price, category, images }).then(({ data }) => {
            if (data.length > 0) {
                setTimeout(() => {
                    navigate("/");
                }, 1500);
                ...
                <Col md={6} className="new-product__form--container">
                    <Form style={{ width: "100%" }} onSubmit={handleSubmit}>
                        ...
                        <Form.Group className="mb-3">
                            ...
                            <Form.Control as="textarea" placeholder="Product talles" style={{ height: "100px" }} value={talles} required onChange={(e) => setTalles(e.target.value)} />
                        </Form.Group>

                        <Form.Group className="mb-3">
                            <Form.Label> tela</Form.Label>
                            <Form.Control as="textarea" placeholder="Product tela" style={{ height: "100px" }} value={tela} required onChange={(e) => setTela(e.target.value)} />
                        </Form.Group>
